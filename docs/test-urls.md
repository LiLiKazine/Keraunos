...
| Bilibili | `https://b23.tv/BZUxFJQ` | ❌ failed | Short link (redirects to bilibili.com) — `error_kind` TBD from the failure log. H.264/HEVC `dash` should work post Phase 1; AV1 needs Phase 4. |
